...
# --- 4. UI 구성 (보완됨) ---
st.set_page_config(page_title="절친 루아 🐱", page_icon="🐱", layout="centered")
...
st.title("🐱 루아랑 수다 떨기")
st.markdown("<p style='text-align: center; color: #FFB6C1;'>2026년 우리들의 비밀 일기장 ✨</p>", unsafe_allow_html=True)
